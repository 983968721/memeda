...
namespace Zed
{
    internal class program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            _config = new Menu("【哆啦咪欧】影流之主ㄧ劫ㄧ", "Ze-D Is Back", true);
    ...
    .AddItem(new MenuItem("TheLine", "三影连招").SetValue(new KeyBind("T".ToCharArray()[0], KeyBindType.Press)));
			...
			_config.AddSubMenu(new Menu("哆啦咪欧", "by Doramio"));	
			_config.SubMenu("by weilai").AddItem(new MenuItem("qunhao", "交流群：114021875"));
			
            Game.PrintChat("<font color='#881df2'>Zed by Doramio</font> Loaded.");
