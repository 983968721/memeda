    ...
    class Program
    {
        ...
        private static void OnGameLoad(EventArgs args)
        {
            try
            {
                ...
                Game.PrintChat("<font color=\"#0066FF\">[<font color=\"#FFFFFF\">Doramio</font>]</font><font color=\"#FFFFFF\"> Skin Changer loaded!</font>");
            }
            catch(Exception ex)
            {
                Game.PrintChat("<font color=\"#0066FF\">[<font color=\"#FFFFFF\">Doramio</font>]</font><font color=\"#FFFFFF\"> An error ocurred loading Skin Changer.</font>");
